...
echo ""
echo "Note: Before OpenClaw is fully operational, you might need to"
echo "run the initial onboarding to set up your API keys and configuration."
echo "You can do this by running as the '$OPENCLAW_USER' user:"
echo "sudo -u $OPENCLAW_USER -H bash -c \"export PATH=$OPENCLAW_HOME/.npm-global/bin:\\\$PATH && openclaw onboard\""
echo "======================================================================="
